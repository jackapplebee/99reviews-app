        ...
        <div className="w-full max-w-md">
          ...
          <div className="brutalist-card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="businessName" className="block text-xs font-bold letter-spacing-label uppercase text-black mb-2">
                  BUSINESS NAME
                </label>
                <input
                  id="businessName"
              ...
              <div>
                <label htmlFor="name" className="block text-xs font-bold letter-spacing-label uppercase text-black mb-2">
                  YOUR NAME
                </label>
                <input
                  id="name"
